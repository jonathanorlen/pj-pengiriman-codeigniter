      ...
      <div class="portlet-body">
        ...
        <div class="box-body">            
          ...
          <tbody>
           <?php
           $nomor = 1;
           foreach($hasil_kendaraan as $list){ ?> 
           <tr>
            <td><?php echo $nomor; ?></td>
            <td><?php echo $list->kode_kendaraan; ?></td>
            <td><?php echo $list->nama_kendaraan; ?></td>
            <td><?php echo $list->no_kendaraan; ?></td>
            <td><?php echo $list->stnk; ?></td>
             <td><?php echo cek_status($list->status); ?></td>
