...
<div class="row">
  <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
    <a class="dashboard-stat dashboard-stat-light blue-soft" id="time">
      <div class="visual">
...
<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
  <a class="dashboard-stat dashboard-stat-light blue-steel" id="sopir">
    <div class="visual">
      <i class="glyphicon glyphicon-taskss" ></i>
    </div>
    <div class="details">
...
<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
  <a class="dashboard-stat dashboard-stat-light green-soft" id="Kendaraan">
    <div class="visual">
      <i class="glyphicon glyphicon-taskss" ></i>
    </div>
    <div class="details">
