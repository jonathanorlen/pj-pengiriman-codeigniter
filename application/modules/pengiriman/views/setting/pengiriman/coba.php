        ...
        <div class="box-body">                   
          ...
          <form id="data_form" action="" method="post">
            <div class="box-body">
              ...
              <label><h3><b>Judulnya</b></h3></label>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">  
                    ...
                    <input readonly="true" type="text" value="" class="form-control" placeholder="Kode Transaksi" name="kode_pembelian" id="kode_pembelian" />
                  </div>
                  <div class="form-group">  
                    <label>Nama</label>
                    <input type="text" class="form-control" placeholder="Nota Referensi" name="nomor_nota" id="nomor_nota" value="" required="" readonly=""/>
                  </div>
                  <div class="form-group">  
                    <label>Alamat</label>
                    <input type="text" class="form-control" placeholder="Kode Po" name="kode_po2" id="kode_po2" required="" value="" readonly="true" />
                  </div>
                  <div class="form-group">  
                    <label>Sopir</label>
                    <input type="text" class="form-control" placeholder="Keterangan" name="keterangan" id="keterangan" value=""  required=""/>
                  </div>
                  <div class="form-group">  
                ...
                <div class="col-md-6">
                 <div class="form-group">
                  ...
                  <input type="text" value="" readonly="true" class="form-control" placeholder="Tanggal Transaksi" id="tanggal_pembelian"/>
                </div>

                <div class="form-group">
                  <label>No Hp</label>
                  <input type="text" name="no_hp" class="form-control" readonly="true" />
                </div>

                <div class="form-group">
                  <label class="gedhi">Tgl Kirim</label>
                  <input type="date"  class="form-control" placeholder="Tanggal barang datang" name="tgl_barang_datang" value="" readonly="true" id="tgl_barang_datang"/>
                </div>
                <div class="form-group">
                  <label class="gedhi">No Kendaraan</label>
                  <input type="date"  class="form-control" placeholder="Tanggal barang datang" name="tgl_barang_datang" value="" id="tgl_barang_datang"/>
                </div>
              </div>
            </div>
          </div> 
            ...
            <div class="box-body">
              <table id="tabel_daftar" class="table table-bordered table-striped" style="font-size:1.5em;">
                ...
                <tbody id="table_penjualan1">
                  ...
                  <?php
                  $kode = 'PEN_171116153423_005_64_10';
                  if(@$kode){
